/**
 * 📝 SEO Blog Pages Module
 * 
 * Educational blog posts and guides about WhatsApp Business API.
 * Optimized for search queries about WhatsApp pricing, comparisons, and best practices.
 * 
 * @module pages/public/seo/blog
 * 
 * Blog Pages:
 * - BlogHome: Blog landing page with post listing
 * - WhatsAppAPIGuide: Complete WhatsApp Business API guide 2025
 * - WhatsAppPricingComparison: Pricing comparison across providers
 * - WhatsAppVsSMS: WhatsApp vs SMS comparison for business
 * 
 * @features
 ...
 * - /blog/whatsapp-pricing-comparison
 * - /blog/whatsapp-vs-sms
 * 
 * @exports
 * - BlogHome
 * - WhatsAppAPIGuide
 * - WhatsAppPricingComparison
 * - WhatsAppVsSMS
 */
