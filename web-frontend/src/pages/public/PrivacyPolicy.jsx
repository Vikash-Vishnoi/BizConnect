 ...
 * GDPR and CCPA compliant privacy disclosure.
 * Covers information collection, data security, retention, and user control.
 * 
 * @component
 * @returns {JSX.Element} Privacy Policy page
 * 
 * @features
 * - GDPR compliance (EU users rights)
 * - CCPA compliance (California privacy rights)
 * - WhatsApp/Meta data sharing disclosure
...
/**
 * Default contact phone fallback
 */
const DEFAULT_CONTACT_PHONE = '+91 98765 43210';
        ...
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <div className="contact-info" role="complementary" aria-label="Contact information">
              ...
              <p><strong>Data Protection Officer:</strong> <a href={`mailto:dpo@${(process.env.REACT_APP_CONTACT_EMAIL || DEFAULT_CONTACT_EMAIL).split('@')[1]}`}>dpo@{(process.env.REACT_APP_CONTACT_EMAIL || DEFAULT_CONTACT_EMAIL).split('@')[1]}</a></p>
              <p><strong>Address:</strong> {process.env.REACT_APP_CONTACT_ADDRESS || DEFAULT_CONTACT_ADDRESS}</p>
              <p><strong>Phone:</strong> <a href={`tel:${(process.env.REACT_APP_CONTACT_PHONE || DEFAULT_CONTACT_PHONE).replace(/\s+/g, '')}`}>{process.env.REACT_APP_CONTACT_PHONE || DEFAULT_CONTACT_PHONE}</a></p>
            </div>
          </section>
