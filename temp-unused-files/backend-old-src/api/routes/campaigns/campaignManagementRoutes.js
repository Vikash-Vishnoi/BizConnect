...
const { Campaign, Template, Contact, CampaignRecipient } = require('../../../database/models');
const campaignService = require('../../../services/campaign/campaignService');
const { validateCreateCampaign, validateUpdateCampaign, validateCampaignId, validatePagination } = require('../../../api/middlewares/validation');
const {  
