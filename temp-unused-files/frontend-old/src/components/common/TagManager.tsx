// Tag Manager - Manage, filter, and analyze conversation tags
...
export const TagManager: React.FC<TagManagerProps> = ({
  ...
  // Delete disabled - tags retained for historical data integrity
  // Use merge functionality to consolidate tags instead
  // const handleDeleteTag = (tag: Tag) => {
  //   Alert.alert('Info', 'Tag deletion is disabled. Use merge to consolidate tags.');
  // };
  ...
  const renderTagItem = ({ item }: { item: Tag }) => (
    <View style={styles.tagItem}>
      ...
      <View style={styles.tagActions}>
        ...
        {/* Delete button removed - tags retained for data integrity */}
        {/* Use merge functionality to consolidate tags */}
      </View>
    </View>
  );
