// Business Settings - Manage details, team, and credentials
...
const BusinessSettingsScreen: React.FC<Props> = ({ navigation }) => {
  ...
  // Delete disabled - businesses use soft delete (status='deleted')
  const handleDeleteBusiness = async () => {
    Alert.alert(
      'Delete Disabled',
      'Business deletion is disabled. Businesses are archived instead of deleted for data compliance.',
      [{ text: 'OK' }]
    );
  };
