/**
 * Status List Screen - View 24-hour status updates with analytics
 */
  ...
  const renderStatusItem = ({ item }: { item: Status }) => (
    <Animated.View
      ...
      <View style={styles.statusPreview}>
        {item.type === 'text' ? (
          <View style={[styles.textPreview, { backgroundColor: item.backgroundColor || theme.colors.primary }]}>
            <Text
    ...
    <View style={styles.container}>
      ...
      <LinearGradient
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('StatusComposer')}
        >
          <Icon name="plus-circle" size={28} color={theme.colors.textInverse} />
        </TouchableOpacity>
      </LinearGradient>
