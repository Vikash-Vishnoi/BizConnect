          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={[styles.inputWrapper, nameError && styles.inputWrapperError]}>
                <Icon name="account" size={20} color={theme.colors.textTertiary} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
              ...
              {nameError ? (
                <View style={styles.errorContainer}>
                  <Icon name="alert-circle" size={14} color={theme.colors.error} style={styles.errorIcon} />
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={[styles.inputWrapper, emailError && styles.inputWrapperError]}>
                <Icon name="email" size={20} color={theme.colors.textTertiary} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={[styles.inputWrapper, passwordError && styles.inputWrapperError]}>
                <Icon name="lock" size={20} color={theme.colors.textTertiary} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
