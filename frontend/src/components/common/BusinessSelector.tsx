 ...
 * 
 * Dropdown component for switching between businesses
 */
  ...
  if (!currentBusiness) {
    return (
      <TouchableOpacity style={styles.emptyButton} onPress={handleCreateNew}>
        <Icon name="plus-circle" size={18} color="#25D366" />
          ...
          <View style={styles.modalContent}>
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  {item._id === currentBusiness._id && (
                    <Icon name="check" size={20} color="#25D366" />
                  )}
                </TouchableOpacity>
              )}
            ...
            {showCreateButton && onCreateNew && (
              <TouchableOpacity
                ...
                disabled={switching}
              >
                <Icon name="plus-circle" size={20} color="#25D366" />
