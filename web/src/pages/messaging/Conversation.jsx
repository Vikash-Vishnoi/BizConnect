...
import { MdSend, MdAttachFile, MdImage, MdCheckCircle, MdError, MdAccessTime } from 'react-icons/md';
...
const Conversation = () => {
  ...
  const loadMessages = async () => {
    try {
      const data = await inboxService.getMessages(id, { limit: 100 });
        ...
        <div className="message-content">
          ...
          {message.type === 'image' && (
            <div className="message-media">
              <img src={message.content?.url || message.mediaUrl} alt="Image" />
          ...
          {message.type === 'video' && (
            <div className="message-media">
              <video controls src={message.content?.url || message.mediaUrl} />
              {message.content?.caption && (
                <div className="message-text">{message.content.caption}</div>
              )}
            </div>
          ...
          {message.type === 'audio' && (
            <div className="message-media">
              <audio controls src={message.content?.url || message.mediaUrl} />
            </div>
          )}
