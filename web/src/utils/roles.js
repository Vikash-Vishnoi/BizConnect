...
export const PAGE_ACCESS = {
  ...
  '/scheduled-messages': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN, ROLES.MANAGER],
  ...
  '/roles': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/audit-log': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/alerts': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/phone-health': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/quality-rating-history': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/message-errors': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN, ROLES.MANAGER],
  '/rate-limits': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/privacy': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  '/optin-manager': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN],
  
  // Settings
  '/settings': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN, ROLES.MANAGER, ROLES.USER],
  '/search': [ROLES.SUPER_ADMIN, ROLES.BUSINESS_ADMIN, ROLES.MANAGER, ROLES.USER],
