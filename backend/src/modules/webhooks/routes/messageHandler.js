 ...
 */
function updateConversationWindow(conversation, timestamp, messageType = 'text', templateCategory = null) {
  ...
  // P0 FIX: Track conversation category for billing
  if (messageType === 'template') {
    // Set category based on template type
    conversation.window.category = templateCategory || 'MARKETING';
  } else {
    // User-initiated conversation
    conversation.window.category = 'SERVICE';
  }
}
